<%@ Page Title="" Language="C#" MasterPageFile="~/Master/SiteOne.Master" enableEventValidation="false" AutoEventWireup="true" CodeBehind="BhandsForCustomerInformation.aspx.cs" Inherits="BarunnIntergrationService.Member.BhandsForCustomerInformation" ClientIDMode="Static" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <link href="/resources/css/Member/BhandsForCustomerInformation.css" rel="stylesheet">
    ...
    <script type="text/javascript" src="/resources/js/Member/BhandsForCustomerInformation.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <!-- contents -->
	<div class="cont_a">
    	<div class="cont_a_in"> 
            <!-- 본인인증 -->
            <div class="check_all_area">
                <h3 class="b_talign_l b_mt20" style="padding-bottom:20px; border-bottom:1px solid #d9d9d9;">본인인증</h3>
                <div class="b_dtable_1">
                    <p class="w_100 Auth_off" style="text-align:  center; line-height: 50px; height: 50px; background: #acacac; color:  #fff;">인증이 완료되었습니다.</p>
                    <div class="space" id="dlName" runat="server" >
                      <%--<input name="txtUserName" type="txt" id="txtUserName" runat="server" placeholder="휴대폰 인증 시 자동입력됩니다" maxlength="25" readonly="readonly" value="">--%>
                      <input type="text" name="txtUserName" id="txtUserName" runat="server" placeholder="휴대폰 인증 시 자동입력됩니다" maxlength="25" readonly="readonly" />
                      <asp:Literal ID="ltrUserName" runat="server"></asp:Literal>
                    </div>
                    <div class="space" id="dlBirthDate" runat="server">
                        <div class="b_sel_line">
                            <select id="selBirthDateForYear" runat="server" ></select>
                        </div><label for="select_big1_1" style="padding-left:2%">년</label>

                        <div class="b_sel_line">
                            <select id="selBirthDateForMonth" runat="server"></select>
                        </div><label for="select_big1_1"  style="padding-left:2%">월</label>


                        <div class="b_sel_line">
                            <select id="selBirthDateForDay" runat="server"></select>
                        </div><label for="select_big1_1" style="padding-left:2%">일</label>
            ...
            <!-- 기본 정보입력 -->
            <div class="check_all_area">
                <h3 class="b_talign_l" style="padding:40px 0px 20px 0px; border-bottom:1px solid #d9d9d9;">기본정보</h3>
                
                <!-- b_dtable_1 -->
                <div class="b_dtable_1 information_wrap">
                  <p class="space" id="dlUserId" runat="server">
                    <input name="txtID" type="text" id="txtID" title="아이디를 넣어주세요" runat="server" placeholder="아이디" class="jtxtoff">
                    <span class="noti">공백 없는 영문, 숫자 포함 6~16자</span> 
                    <asp:Literal ID="ltrID" runat="server"></asp:Literal>
                  </p>
                  <p class="space" id="dlPassword"  runat="server">
                    <input name="txtPassword" type="password" id="txtPassword" title="비밀번호를 넣어주세요" runat="server" placeholder="비밀번호" maxlength="16" class="jtxtoff">
                    <span class="noti">영문으로 시작하는 6~16자의 영문+숫자 조합</span> 
                  </p>
                  <p class="space2" id="dlPasswordConfirm" runat="server">
                    <input name="txtPasswordConfirm" type="password" id="txtPasswordConfirm" class="" title="비밀번호를 한번 더 넣어주세요" runat="server" placeholder="비밀번호 확인" maxlength="16">
                    <span class="noti">비밀번호가 일치하지 않습니다.</span> 
                  </p>
                  <div class="space" id="dlAddress" runat="server">
                    <input name="txtZipCode1" type="text" id="txtZipCode1" runat="server" class="b_talign_c post-postcode1" maxlength="1" title="우편번호" readonly="readonly">
                    <input name="txtZipCode2" type="text" id="txtZipCode2" runat="server" class="b_talign_c post-postcode2" maxlength="1" title="우편번호" readonly="readonly">
                    <input name="txtZipCode3" type="text" id="txtZipCode3" runat="server" class="b_talign_c post-postcode3" maxlength="1" title="우편번호" readonly="readonly">
                    <input name="txtZipCode4" type="text" id="txtZipCode4" runat="server" class="b_talign_c post-postcode4" maxlength="1" title="우편번호" readonly="readonly">
                    <input name="txtZipCode5" type="text" id="txtZipCode5" runat="server" class="b_talign_c post-postcode5" maxlength="1" title="우편번호" readonly="readonly">
                    <button class="b_btn type3 post-submit b_float_r postcode" postcode-index="0" postcode-type="zonecode" postcode-input-cnt="5"><span>우편번호 검색</span></button>
                    <div id="wrapPostCode" style="position:relative; display:none;"> <img src="//t1.daumcdn.net/localimg/localimages/07/postcode/320/close.png" id="btnFoldWrap" style="cursor:pointer;position:absolute;right:5px;top:15px;z-index:1" onclick="foldDaumPostcode()" alt="접기 버튼"> </div>
                    <div style="margin-top:10px;">
                      <input name="txtAddress" type="text" id="txtAddress" runat="server"  class="b_float_l post-address" title="주소를 넣어주세요" placeholder="동,면,읍 이상" readonly="readonly"><br/>
                      <input name="txtAddressDetail" type="text" id="txtAddressDetail" runat="server" title="나머지 주소를 넣어주세요" placeholder="나머지 주소(직접입력)" maxlenth="50" class="b_float_r" style="margin-top:0.5em; float:left; margin-bottom:8px !important;">
                    </div>
                  </div>
                  
                  <!--전화번호-->
                  <div class="space" id="dlPhone" runat="server"  style="padding-top:5px !important; ">
                    <div class="b_sel_line">
                        <select name="txtPhone1" id="txtPhone1"  runat="server" title="국번을 넣어주세요"  tabindex="0">
                    ...
                    &nbsp;&nbsp;-&nbsp;&nbsp;
                    <input name="txtPhone2" type="text" runat="server" id="txtPhone2" class="b_talign_c" title="전화번호 중간자리" maxlength="4">
                    &nbsp;&nbsp;-&nbsp;&nbsp;
                    <input name="txtPhone3" type="text" runat="server" id="txtPhone3" class="b_talign_c "  title="전화번호 끝자리" maxlength="4">
                  </div>
                  <!--/전화번호--> 
                  
                  <!--휴대폰번호-->
                  <div class="space" id="dlHphone" runat="server" style="padding-top:8px !important;" >
                    <div class="b_sel_line">
                        <select name="txtHPhone1" id="txtHPhone1" runat="server" title="국번을 넣어주세요" tabindex="0" disabled>
                    ...
                    &nbsp;&nbsp;-&nbsp;&nbsp;
                    <input name="txtHPhone2" type="text" runat="server" id="txtHPhone2" class="b_talign_c" title="핸드폰 번호 중간자리" maxlength="4" readonly>
                    &nbsp;&nbsp;-&nbsp;&nbsp;
                    <input name="txtHPhone3" type="text" runat="server" id="txtHPhone3" class="b_talign_c" title="핸드폰 번호 끝자리" maxlength="4" readonly>
                    <asp:Literal ID="ltrHphoneNbspField" runat="server"></asp:Literal>
                    &nbsp;&nbsp;
                    <div class="input_b2 size_sm type2 b_float_l sms" style="width:100%;">
                  ...
                  <!--이메일-->
				  <div id="dlEmail" runat="server">
					  <input name="txtEMailHeader" type="text" id="txtEMailHeader" runat="server" title="이메일을 넣어주세요"  placeholder="이메일">
					  &nbsp;@&nbsp;
					  <input name="txtEMailFooter" type="text" id="txtEMailFooter" runat="server" title="이메일을 넣어주세요" class="jtxtoff">
					  
					  <div class="b_sel_line b_sel_line2">
						<select name="selEMailFooter" runat="server" id="selEMailFooter" title="이메일선택"  tabindex="0">
					  ...
					  <div class="row noti_email">
						<div class="input_b size_sm type2">
						  <div class="ez-checkbox ez-checked">
							<input name="chkMailServiceYorN" type="checkbox" runat="server" id="chkMailServiceYorN" checked class="ez-hide">
						  </div>
						  <label for="chkMailServiceYorN"><strong>메일 수신설정</strong></label>
						</div>
                  ...
                  <!--예식일-->
                  <div class="space input-group date"  id="dlWeddingDayField" runat="server">
                    <input name="txtWeddingDay" type="text" id="txtWeddingDay" runat="server" class=" datepicker" title="예식일을 넣어주세요" readonly="readonly" placeholder="예식일">
                    <button class="b_btn type3 b_float_r input-group-addon btnCalendarIcon calendar_v" type="button"><span>달력보기</span></button>
                  </div>
                  <!--/예식일-->
                  ...
                  <dl id="dlWeddingHallField" class="whall" runat="server">
                    ...
                    <dd>
                      <div class="input_b size_sm type2">
                        <div class="ez-radio">
                          <input value="W" name="rdoWeddingHall" runat="server" type="radio" id="rdoWeddingHall_W" class="ez-hide">
                        </div>
                        <label for="rdoWeddingHall_W">예식홀</label>
                      </div>
                      <div class="input_b size_sm type2">
                        <div class="ez-radio">
                          <input value="H" name="rdoWeddingHall" runat="server" type="radio" id="rdoWeddingHall_H" class="ez-hide">
                        </div>
                        <label for="rdoWeddingHall_H">호텔</label>
                      </div>
                      <div class="input_b size_sm type2">
                        <div class="ez-radio">
                          <input value="C" name="rdoWeddingHall" runat="server" type="radio" id="rdoWeddingHall_C" class="ez-hide">
                        </div>
                        <label for="rdoWeddingHall_C">종교장소</label>
                      </div>
                      <div class="input_b size_sm type2">
                        <div class="ez-radio">
                          <input value="M" name="rdoWeddingHall" runat="server" type="radio" id="rdoWeddingHall_M" class="ez-hide">
                        </div>
                        <label for="rdoWeddingHall_M">군관련기업</label>
                      </div>
                      <div class="input_b size_sm type2">
                        <div class="ez-radio">
                          <input value="E" name="rdoWeddingHall" runat="server" type="radio" id="rdoWeddingHall_E" class="ez-hide">
                        </div>
				  ...
				  <dl id="dlWeddingHallField2" class="whall">
						...
						<dd style="width: 75%;">
							<input type="text" name="txtWeddName" id="txtWeddName" runat="server" placeholder="Ex) 루이비스 다산홀" style="width: 95%;" maxlenth="50">
						</dd>	
                 </dl>
			...
			<div class="term_s barun_s">
			    ...
			    <div class="samsung_s" id="wrapSamsungAgreement" runat="server">
					    ...
					    <div class="txt_a">
							<h2>
								<div class="input_b size_sm type1">
									...
									<label for="chkChoiceAgreementForSamSungMembership">삼성전자 멤버십 회원 이용약관 <span>(선택)</span></label>
								</div>
							</h2>
			        ...
			        -	멤버십 혜택 제공 (포인트 적립 및 사용, 프리미엄 등급 혜택)
								        ...
								        <ol>
                                            ...
                                            <li>
                                                ...
                                                <div class="input_b size_sm type1" style="margin: 10px 0 0px 21px;">
										            <div class="ez-checkbox">
											            <div class="ez-checkbox"><div class="ez-checkbox"><input name="chkChoiceAgreementForSamSungChoiceYearlData" type="checkbox" id="Checkbox1" value="Y" class="ez-hide agreement-samsung" runat="server"></div></div>
										            </div>
						...
						<!-- / 삼성전자 개인정보 제3자 제공 동의 -->
					    <h2><div class="input_b size_sm type1"><div class="ez-checkbox"><input type="checkbox" name="chkChoiceAgreementForSamSungThirdParty" id="Checkbox5" value="Y" class="ez-hide agreement-samsung"  runat="server"></div><label for="chkChoiceAgreementForSamSungThirdParty">삼성전자 멤버십 개인정보 제3자 제공 <span>(선택)</span></label></div></h2>
                ...
                <!--%%%%%%%%%%%%%%%%%%%%%%%%%%%%%     20200702 회원약관 LG 추가     %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%-->
					<div class="term_b" style="width:100%;">
						...
						<div id="wrapLGAgreement" class="samsung_s " runat="server">
							<!-- / LG전자 전체 동의 그룹-->
							<div style="margin: 0 auto; border: 1px solid #f9f9f8; background: #f9f9f8; height: 85px; overflow-x: hidden;">
...
<div class="txt_a">
								...
								<div style="float:left; width:100%;">
									...
									<!-- 약관box -->
									<div class="txt_a_new" style="width: 94%; margin:0 auto; ">
										<!-- policy영역 -->
										<div class="policy_a">
						...
						<h2><div class="input_b size_sm type1"><div class="ez-checkbox"><input type="checkbox" name="chkChoiceAgreementForLGMembershipALL" id="chkChoiceAgreementForLGMembershipALL" value="Y" class="ez-hide agreement-lg" runat="server"></div><label for="chkChoiceAgreementForLGMembershipALL">LG전자 멤버십 전체 이용 약관 동의 <span>(선택)</span></label></div></h2>
				...
				<div class="term_b" style="width:100%;">
					<div id="wrapCsAgreement" class="samsung_s">
						<div class="txt_a txt_a_new" style="border: 1px solid #ddd;">
							<div>
				...
				<!-- 쿠쿠 동의 -->
                <!--
				<div id="wrapCuckooAgreement" class="samsung_s" runat="server">
					...
					<div style="width: 99%; margin: 0 auto; border: 1px solid #ddd; background: #f9f9f8; height: 85px; overflow-y: scroll; overflow-x: hidden;">
						<div class="term_b" style="float:left; width:100%;">
							...
							<div class="txt_a txt_a_new" style="width: 94%; border:1px solid #f9f9f8; ">
								...
								<div class="policy_a">
									<ol>
										<li>개인정보를 제공받는 자: 쿠쿠홈시스㈜</li>
										<li>개인정보 제공 목적: 전화를 이용한 쿠쿠홈시스 상품,서비스 안내 및 판매, 그 외 문자, 이메일을 이용한</li>
										<li>할인/사은/판촉행사 등 정보 제공</li>
										<li>개인정보 제공 항목: 성명,휴대폰번호,생년월일,성별,주소,이메일,예식일,동의일시,동의매체</li>
										<li>개인정보 보유 및 이용기간: 제공 동의일로부터 1년 (고객동의 철회 시 지체없이 파기)</li>
										<li>※ 위와 같은 본인의 개인정보 수집, 이용에 관한 동의를 거부할 권리가 있습니다. 단, 동의 거부 시 상품 정보 제공 등 서비스를 제공받을 수 없습니다.</li>									
									</ol>
								</div>
					...
					<h2 style="overflow: hidden;text-align: left;	margin: 19px 0 13px 5px;">
						<div class="input_b size_sm type1">
							<div class="ez-checkbox">
								<div class="ez-checkbox"><div class="ez-checkbox"><div class="ez-checkbox"><input name="chkChoiceAgreementForCuckooMembership" type="checkbox" id="chkChoiceAgreementForCuckooMembership" value="Y" class="ez-hide agreement-cuc" runat="server"></div></div></div>
							</div>
							<label for="chkChoiceAgreementForCuckooMembership" style="position:absolute;margin: 0 0 0 2px;">쿠쿠홈시스 마케팅 활용동의<span>(선택)</span></label>
						</div>
					</h2>
				</div>
                -->
				...
				<!-- 개인정보 취급위탁동의 -->
				<div class="term_b"  style="float:left; width:100%;" id="wrapThirdPartyAgreement" runat="server">
					<!-- 약관box -->
					<div class="txt_a">
						<!-- policy영역 -->
						<div class="policy_a">
	...
	<%--<a id="btnSave"  class="b_btn type2" runat="server" OnClick="btnSave_Click" OnClientClick="return ValidationCheck();"><span>가입완료하기</span></a> </button>--%>
    <asp:LinkButton ID="LinkButton1" CssClass="b_btn type2" runat="server" OnClick="btnSave_Click" OnClientClick="return Information.ValidationCheck();"><span>가입완료하기</span></asp:LinkButton>
	<!-- / 하단버튼 --> 
	</div>
	<!-- /contents -->
