...
namespace BarunnIntergrationService.Common.ExtensionMethod
{
    ...
    {
        public static string Value(this HttpRequest r, string s)
        {
            string result = String.Empty;
            try
            {
                result = String.IsNullOrEmpty(r[s]) ? "" : r[s];
            }
            catch
            { }
        ...
        public static bool IsMobileDevice(this HttpRequest r)
        {
            ...
            if (r != null && r.ServerVariables["HTTP_USER_AGENT"] != null)
            {
                var u = r.ServerVariables["HTTP_USER_AGENT"].ToString();
