<%@ Page Title="" Language="C#" MasterPageFile="~/Master/SiteOne.Master" AutoEventWireup="true" enableEventValidation="false" CodeBehind="BarunsonMallForCustomerInformation.aspx.cs" Inherits="BarunnIntergrationService.Member.BarunsonMallForCustomerInformation" ClientIDMode="Static" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <link href="/resources/css/Member/PremierForCustomerInformation.css" rel="stylesheet">
    ...
    <script type="text/javascript" src="/resources/js/Member/BarunsonMallForCustomerInformation.js"></script>
...
*/
		...
		.step_a ul li.m-line { width: 40px; height: 0; border: solid 1px #3e84d9; margin: 34px 20px 0 20px;}
        .step_a ul li span{width: 20px;height: 20px; display: block; border-radius: 20px; text-align: center; line-height: 20px; margin: 10px auto; font-weight: bold;color: #c8c8c8;border: 1px solid #c8c8c8;}
		...
		.are_li li {display:inline-block;}
			...
			.b_dtable_1 dt.mark p{background: none no-repeat 20px 50% !important;}
			...
			.cont_a{font-size:16px;}
			.cont_a p{font-size:16px;}
			
.agreement_wrap .agreeall_a label strong {
    font-size: 16px;
    top: 0px;
    color: #333;
    font-weight: bold;
...
.agreement_wrap .input_b.type1 label {
    font-size: 15px;
    color: #333333;
}
...
.b_btn.type3 {background-color:#2e96ff !important }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="cont_a">
        ...
        <div class="cont_a_in">
            ...
            <div class="b_dtable_1 information_wrap">
                ...
                <dl id="dlEmail" runat="server">
                  ...
                  <dd>
                    <input name="txtEMailHeader" type="text" id="txtEMailHeader" runat="server" style="width:200px;" title="이메일을 넣어주세요">
                    @
            ...
            <div class="b_dtable_1 agreement_wrap check_all_area" style="padding:0 15px;">
                ...
                <div class="term_s barun_s">
							...
							<div class="txt_a">
								...
								<div class="policy_a">
									...
									<div>
										<ul class="type_num">
											<li>
												1. 회사는 다음에 해당하는 게시물이나 자료를 사전통지 없이 삭제, 이동, 등록 거부 할 수 있습니다.
												<ul class="type_abc">
							...
							<div class="txt_a">
								...
								<div class="policy_a">
									...
									<div>
										<ul class="type_num">
											<li>
												1. 회사는 다음과 같은 목적을 위하여 아래 항목의 개인정보를 수집하고 있습니다.
												<ul class="type_abc">
													...
													<li>
														G. 그 외 선택항목: 개인맞춤 서비스를 제공하기 위한 자료<br>
										...
										<ul class="type_num">
											<li>
												...
												<ul class="type_abc">
													...
													<li>
														B. 선택항목 : 신랑이름, 신부이름, 양가부모이름, 인사말 등 청첩장 제작 시 기입정보<br>
									...
									<div>
										<ul class="type_num">
											...
											<li>
												2. 회원가입정보의 경우, 회원을 탈퇴하거나 회원에서 제명된 경우 등 사전 보유목적, 기간 및 보유하는 개인정보 항목을 명시하여 동의를 구합니다.
												<ul class="type_abc">
								...
								<!-- 20220816 추가 Start -->
								 <h3>[회원탈퇴 및 자격상실/계약해지]</h3>
							    <div>
								    <ul class="type_num">									
									    <li>1. 회원은 언제든지 서면, E-MAIL, 전화, 대표 사이트, 기타 회사가 정하는 방법으로 회원 탈퇴를 요청할 수 있으며, 회사는 회원의 요청에 따라 조속히 회원 탈퇴에 필요한 제반 절차를 수행합니다. 
												단, 회사 대표 사이트를 통하여 회원으로 가입한 경우, 회사 대표 사이트 내 회원 탈퇴는 별도로 회사 대표 사이트에서 직접 탈퇴 신청을 하여야 탈퇴 절차가 완료됩니다.
										</li>
									    <li>2. 회원이 다음 각 호의 사유에 해당하는 경우, 회사는 당해 회원에 대한 통보로서 회원의 자격을 상실(또는 계약 해지) 시킬 수 있습니다.
												<ul class="type_abc">
													<li>① 회원이 사망한 경우</li>
													<li>② 회원이 회사가 정하지 않은 방법으로 상품을 부정 구매한 경우</li>
													<li>③ 회원이 가입 신청 시에 허위의 내용을 등록한 경우</li>
													<li>④ 다른 사람의 ID와 비밀번호 또는 그 개인 정보를 도용한 경우</li>
													<li>⑤ 사이트 내에서 다른 사람의 명예를 훼손하거나 이용을 방해하는 경우</li>
													<li>⑥ 사이트 이용과정 중에 회사의 직원에게 폭언, 협박 또는 음란한 언행 등의 행위로 피해를 주는 경우</li>
													<li>⑦ 사이트를 통해 재화 등을 구매한 후 정당한 이유 없이 상습 또는 반복적으로 취소, 반품하여 업무를 방해하는 경우</li>
												</ul>
											
										 </li>
										<li>
											3. 위 제2항의 사유로 회원 자격이 상실된 회원은 본 조 제2항 각호의 사유가 자신의 고의 또는 과실에 기한 것이 아님을 소명할 수 있습니다. 이 경우 회사는 회원의 소명 내용을 심사하여 회원의 주장이 타당하다고 판단하는 경우 회원으로 하여금 정상적으로 사이트 내 서비스를 이용할 수 있도록 할 수 있습니다.
										</li>
										<li>
											4. 회원 탈퇴 또는 자격의 상실이 확정될 경우, 그때까지 사용하지 않은 잔여 쿠폰 등의 혜택은 함께 소멸됩니다.
										</li>
									</ul>
							    </div>
								 <h3>[개인정보 제3자 제공]</h3>
								<div>
								    <ul class="type_num">									
									    <li>
											1. ㈜바른컴퍼니(이하 회사)는 고객님의 개인 정보를 가입 신청서, 서비스 이용약관, 개인 정보 수집 목적 및 이용목적에서 알린 범위 내에서 사용하며, 이 범위를 초과하여 이용하거나 타인 또는 다른 기업 • 기관에 제공하지 않습니다. 단, 고객의 동의가 있거나 법령에 의하여 정해진 절차에 따라 정보를 요청받은 경우는 예외로 하며, 이 경우 주의를 기울여 개인 정보를 이용 및 제공할 수 있습니다.
										</li>
										<li>
											2. 회원가입 진행 시, 고객에게 별도로 알리고 동의 받는 절차가 진행됩니다. 제3자 제공 동의를 거부하실 수 있으며, 동의 거부는 회원가입과 서비스 사용에 영향을 미치지 않습니다.
										</li>
										<li>
											3. 회원이 마케팅 활용 동의를 통해 이미 제공된 회원정보에 대해 동의 철회를 요청하시는 경우, 동의 상태 변경 또는 철회 요청일로부터 15일 이내에, 회원님의 정보는 기술적인 방법으로 복구 불가하도록 안전하게 철회 및 삭제 처리됩니다.
										</li>
										<li>
											4. 회원이 탈퇴하여 회원의 자격이 상실된 경우, 회사 내 회원정보는 삭제되어 소멸됩니다. 하지만 고객이 동의하여 제3자에게 제공된 회원정보는 회사에서 삭제가 불가합니다. 따라서 이에 따른 손해는 회사의 귀책사유가 아니며, 해당 정보는 직접 제공받은 자에게 철회 및 삭제 처리를 요청해야 합니다
										</li>
									</ul>
								</div>
                    ...
                    <!-- 삼성전자 동의 -->
                <%--    <div id="wrapSamsungAgreement" class="samsung_s">
                        <!-- 삼성전자 멤버십 회원 이용 약관 -->
                        <div class="term_b" style="position:relative; width:100%;">
									
								<h2 style="text-align: left;"><div class="input_b size_sm type1"><div class="ez-checkbox"><div class="ez-checkbox"><div class="ez-checkbox"><input name="chkChoiceAgreementForSamSungMembershipALL" type="checkbox" id="chkChoiceAgreementForSamSungMembershipALL" value="Y" class="ez-hide agreement-samsung_main"></div></div></div>
									<label for="chkChoiceAgreementForSamSungMembershipALL">삼성전자 멤버십 개인정보 제3자 제공 <span>(선택)</span><a href="javascript:void(0);" onclick="openLayer('layerPop3')" class="close" style="padding:0 0 0 10px;">
									<img src="/Resources/member/btn.svg"></a><br><span style="font-size:12px;">※ 회원약관, 필수적/선택적 개인정보 수집이용, 선택적 개인정보 제3자 제공, 마케팅 정보 수신에 동의합니다.</span></label></div></h2>
									
							<div id="layerPop3" class="layerPop">
								<div class="are_wrap">
									<h3>삼성전자 멤버십 개인정보 제3자 제공(선택)<a href="javascript:void(0);" onclick="closeLayer('layerPop3')" class="close"><img src="/Resources/member/ico-x.svg"></a></h3>
								</div>
								<!-- 약관box -->
								<div class="txt_a">
									<h2>
										<div class="input_b size_sm type1">
											<div class="ez-checkbox">
												<div class="ez-checkbox"><div class="ez-checkbox"><input name="chkChoiceAgreementForSamSungMembership" type="checkbox" id="chkChoiceAgreementForSamSungMembership" value="Y" class="ez-hide agreement-samsung"></div></div>
											</div>
											<label for="chkChoiceAgreementForSamSungMembership" style="font-weight:normal;">삼성전자 멤버십 회원 이용약관 <span>(선택)</span></label>
										</div>
									</h2>
									<!-- policy영역 -->
									<div class="policy_a">
										<h3 style="    padding:0 0 10px 0;">제1장 총칙</h3>
										<h3>제1조 (목적)</h3>
										...
										<ol>
											...
											<li>
												제2항의 회원 가입신청이 있더라도 삼성전자는 다음 각 호의 사유가 있는 경우에는 회원 가입을 승낙하지 않습니다.
												<ol>
										...
										<ol>
											...
											<li>
												회원이 다음 각 호의 사유에 해당하는 경우, 삼성전자는 즉시 해당 회원에게 부여된 회원의 지위 및 멤버십 서비스를 정지 또는 상실시킬 수 있으며, 이 경우 삼성전자는 회원의 지위 및 멤버십 서비스가 정지 또는 상실되었음을 정지ㆍ상실일로부터 1개월 이내에 서면, 전화, 전자우편(E-MAIL), SMS 등의 방법 중 1가지 이상을 통하여 회원에게 알려 드립니다. 또한 아래 사유 발생에 따라 회원자격 정지ㆍ상실된 회원은 향후 멤버십 가입이 제한될 수 있습니다. 제한 기간은 삼성전자가 별도로 정합니다.
												<ol>
													<li>회원가입 신청 시, 허위의 내용을 기재ㆍ등록한 경우</li>
													<li>
														회원이 사망한 경우<br>
														(이 때 회원 자격 및 기타 멤버십 서비스와 관련된 권리나 의무는 회원의 상속인에게 상속되지 않으며, 상속인에게 별도의 통보를 하지 않습니다.)
													</li>
													...
													<li>
														구매금액 또는 삼성전자 포인트를 부정적립 또는 부정사용 하는 경우 및 멤버십카드를 부정 사용한 경우 <br>
														...
														- 부정 적립 또는 부정 사용한 회원은 적립 및 사용된 포인트나 그 상당액을 반환하여야 합니다.
													</li>
												</ol>
											</li>
											...
											<li>
												본 조 제1항에 의한 회원 탈회 또는 제2항에 의한 회원자격 정지ㆍ상실이 확정되는 시점은 다음 각 호와 같습니다.
												<ol>
										...
										<ol>
											<li>
												멤버십카드의 종류는 멤버십카드를 사용할 수 있는 제휴사 및 제휴가맹점에 따라 달라 질 수 있습니다.
												자세한 멤버십카드의 종류는 홈페이지를 통해 확인하실 수 있으며, 사정에 따라 멤버십카드의 종류는 변경될 수 있습니다.
											</li>
											<li>멤버십카드 발급을 원하는 회원은 삼성전자, 지정매장, 제휴사 및 제휴가맹점이 정한 신청 양식에 신청자 필수 정보 사항을 기재 또는 입력하여 멤버십카드 발급을 신청할 수 있습니다.</li>
											<li>
												멤버십카드 발급은 지정매장 또는 홈페이지에서 신청하실 수 있습니다. 단, 일부 지정매장에서는 멤버십카드 발급이 제한될 수 있으며,
												이는 지정매장이 소속된 타 회사 및 사업장의 자체 정책에 의한 것이므로 삼성전자가 강제할 수 없음을 알려 드립니다.
											</li>
										...
										<ol>
											...
											<li>
												제2항의 규정에도 불구하고 삼성전자는 다음 각 호의 어느 하나에 해당하는 경우에는 그 책임의 전부 또는 일부를 회원이 부담하게 할 수 있습니다.
												<ol>
										...
										<ol>
											<li>
												삼성전자는 멤버십카드를 발급받고 삼성전자, 지정매장에서 제품 및 서비스(삼성전자가 정책에 따라 국내에 직접 공급한 제품 및 서비스에 한하며, 삼성전자가 아닌 타사가 공급하거나 삼성전자가 생산하였더라도 직접 공급하지 않은 제품 및 서비스는 제외됩니다.)를 구매하여 구매금액 결제 및 배송이 완료된 회원, 혹은 삼성전자가 제시한 적립 조건을 충족하는 회원에게, 구매금액×적립율(단, 퍼센트 단위 소수점이하 절사, 이하 같음), 혹은 사전에 고지한 금액의 삼성전자 포인트를 삼성전자의 정책에 따라 지정한 일자에 적립해 드립니다. <br>
												단, 삼성전자 포인트의 적립은 고객의 구매정보 및 구매 금액이 확인되어야만 적립 가능하며, 일부 지정 매장, 제휴사 및 제휴가맹점에서는 삼성전자 포인트 적립이 제한될 수 있습니다. 삼성전자 포인트 적립이 가능한 지정 매장, 제휴사 및 제휴가맹점은 변경 될 수 있으며, 홈페이지를 통해 구체적인 내용을 확인할 수 있습니다.
											</li>
											...
											<li>
												삼성전자는 하기 유형의 회원에게는 삼성전자 포인트를 적립하지 않습니다. 만일 아래 해당하는 회원이 삼성전자 포인트 적립을 받았을 경우 해당 삼성전자 포인트를 반환해야 하고, 삼성전자 포인트를 이미 사용했다면 포인트 상당 금액을 반환하여야 합니다.
												<ol>
													<li>전자제품 판매업자</li>
										...
										<ol>
											...
											<li>
												삼성전자는 아래의 경우에는 회원의 동의를 얻지 아니하고 제3자에게 개인정보를 제공할 수 있습니다.
												<ol>
										...
										<ol>
											...
											<li>
												본 조 제1항에도 불구하고 상법 등 관련 법령의 규정에 의하여 거래 관련 권리의무 관계의 확인 등을 이유로 일정기간 보유해야 할 필요가 있을 경우에는 삼성전자는 관련법령이 정한 기간 또는 다음 각 호의 기간동안 개인정보를 보유할 수 있습니다.
												<ol>
										...
										<ol>
											...
											<li>
												회원은 다음과 같은 방법으로 본 조 제1항에 기재된 회원 개인정보의 열람 또는 정정을 청구 할 수 있습니다. <br>
												- 콜센터(1588-3366)와 통화 <br>
												- 홈페이지를 통해 요청 <br>
												- 지정매장에 방문하여 요청 (단, 해당 지정매장의 회원으로 등록된 경우에 한하며, 지정매장의 정책 및 환경에 따라 일부 지정매장에서는 불가할 수 있습니다.)
											</li>
										...
										<ol>
											...
											<li>
												삼성전자는 홈페이지를 통하여 다음과 같은 업무를 수행합니다.
												<ol>
										...
										<ol>
											<li>
												회원은 홈페이지 서비스 이용과 관련하여 다음 각 호의 행위를 해서는 아니됩니다.
												<ol>
									...
									<!-- policy영역 -->
									<div class="policy_a">
										<h4><div class="input_b size_sm type1"><div class="ez-checkbox"><div class="ez-checkbox"><div class="ez-checkbox"><input name="chkChoiceAgreementForSamSungPersonalData" type="checkbox" id="chkChoiceAgreementForSamSungPersonalData" class="ez-hide agreement-samsung"></div></div></div><label for="chkChoiceAgreementForSamSungPersonalData">필수적인 개인정보 수집 이용 동의 <span>(선택)</span></label></div></h4>
										...
										<ol>
											<li>
												...
												<ol>
													<li>
														결혼 관련 정보 [결혼(예식)예정일, 예식장정보, 구매예정제품], 이사 관련 정보 [이사예정일, 이사예정평수, 구매예정제품, 이벤트신청일], 출산 관련 정보 [출산예정일, 임신 개월수, 자녀 수, 자녀 나이, 구매예정 및 관심제품, 이벤트 신청일], 전역 관련 정보 [전역예정일, 군구분(사병/간부/군무원)]<br>
														※ 단, 결혼/이사/출산/전역 관련 제휴처에서 가입하는 고객에 한하여 수집합니다.
													</li>
												</ol>
												...
												<ol>
													...
													<li>
														서비스 수리 관련정보[수리모델명, 수리일자, 수리내용, 수리비용, 결제수단정보, 결제카드정보, 제조번호, 수리결과, 상담내역]<br>
														...
														[제휴업체명(㈜대명스테이션(대명라이프웨이 상조 서비스), ㈜홀리스트, ㈜케이티씨에스, ㈜LG유플러스(IPTV), ㈜청호나이스(정수기)), 가입여부 및 가입일]
													</li>
												</ol>
											</li>
											<li>수집목적</li>
										...
										<h4><div class="input_b size_sm type1"><div class="ez-checkbox"><div class="ez-checkbox"><div class="ez-checkbox"><input name="Checkbox6" type="checkbox" id="Checkbox6" class="ez-hide agreement-samsung"></div></div></div><label for="chkChoiceAgreementForSamSungPersonalData2">선택적인 개인정보 수집 이용 동의 <span>(선택)</span></label></div></h4>
									...
									<h2><div class="input_b size_sm type1"><div class="ez-checkbox"><div class="ez-checkbox"><div class="ez-checkbox"><input name="chkChoiceAgreementForSamSungChoicePersonalData" type="checkbox" id="chkChoiceAgreementForSamSungChoicePersonalData" value="Y" class="ez-hide agreement-samsung"></div></div></div><label for="chkChoiceAgreementForSamSungChoicePersonalData">삼성전자 멤버십 마케팅 정보 수신 <span>(선택)</span></label></div></h2>
											...
											<ol>
												...
												<li>
													...
													<div class="input_b size_sm type1" style="margin: 10px 0 0px 21px;">
														<div class="ez-checkbox">
															<div class="ez-checkbox"><div class="ez-checkbox"><div class="ez-checkbox ez-checked"><div class="ez-checkbox ez-checked"><input name="Checkbox1" type="checkbox" id="Checkbox1" value="R" class="ez-hide SamSungChoiceYear not-chk" checked="checked"></div></div></div></div>
														</div>
														<label for="chkChoiceAgreementForSamSungChoiceYearlData" style="font-size: 14px;">삼성전자멤버십 탈퇴 시까지</label>
														<span class="container disable-checkbox"><!--<div class="cover"></div>--><div class="ez-checkbox"><div class="ez-checkbox"><input name="Checkbox2" type="checkbox" id="Checkbox2" class="ez-hide SamSungChoiceYear not-chk" value="5"></div></div>5년  <div class="ez-checkbox"><div class="ez-checkbox"><input name="Checkbox3" type="checkbox" id="Checkbox3" class="ez-hide SamSungChoiceYear not-chk" value="3"></div></div>3년  <div class="ez-checkbox"><div class="ez-checkbox"><input name="Checkbox4" type="checkbox" id="Checkbox4" class="ez-hide SamSungChoiceYear not-chk" value="1"></div></div>1년 으로 요청합니다.</span>
													</div>
												</li>
											</ol>
										</div>
									...
									<h2><div class="input_b size_sm type1"><div class="ez-checkbox"><div class="ez-checkbox"><div class="ez-checkbox"><input name="chkChoiceAgreementForSamSungThirdParty" type="checkbox" id="chkChoiceAgreementForSamSungThirdParty" value="Y" class="ez-hide agreement-samsung"></div></div></div><label for="chkChoiceAgreementForSamSungThirdParty">삼성전자 멤버십 개인정보 제3자 제공 <span>(선택)</span></label></div></h2>
											...
											<tbody>
												...
												<tr>
													<td>
														<p align="left">
															-&nbsp; 삼성전자판매㈜, 삼성전자 대리점 <br>
															&nbsp;&nbsp;(<a href="http://www.samsung.com/sec/support/location/supportServiceLocation.do?page=SHOP.LOCATION" target="_blank" title="새창띄움">목록보기</a>)
														</p>
														<ul>
													...
													<td>
														<p align="left">
															...
															※ 제휴사는 삼성전자와 고객에 대한 상품 및 서비스 안내 등과 관련하여 제휴 계약을 체결한 자를 의미합니다.
														</p>
													</td>
													<td>
														<p>
															ㆍ 상품·서비스, 사은·판촉행사, 이벤트 등의 마케팅 활동 안내 및 이용권유<br>
															ㆍ 시장조사, 고객만족도조사, 상품·서비스 개발연구, 고객별 통계분석자료 활용<br>
															ㆍ 회원유치, 통신판매, 전화권유판매, 전화상담업무, SMS·DM·TM·E-mail·Push-mail 발송<br>
															ㆍ TM·SMS·DM·E-mail·Push-mail 등을 통한 사은행사 안내
														</p>
													</td>
												...
												<tr>
													<td>
														<p align="left">
															-&nbsp;고객이 사용하는<br>
															&nbsp;&nbsp;카드사<a href="http://membership.samsung.com/sec/lnc/KoJointMemAgreementPop" onclick="window.open(this.href, 'mywin','left=20,top=20,width=800,height=350,toolbar=1,resizable=0'); return false;">(목록보기)</a>
														</p>
													</td>
													<td>
														<p align="left">
															ㆍ 구입일시, 구입가격, 결제수단정보, 결제카드정보 <br>
															※ 고객이 결제카드의 금융혜택 신청 시, 신청 건에 한하여 해당 결제 카드사에만 제공합니다.
														</p>
													</td>
												...
												<tr>
													...
													<td valign="top">
														<p align="left">
															ㆍ 이름, 주소, 휴대전화번호, 제휴업체의 서비스 신청상품명, 설치 요청일, 본인인증기관으로부터의 인증결과값<br>
														...
														<ol>
															...
															<li>
																...
																<ol>
																	...
																	<li>
																		６. 회원은 개인정보 수집 동의를 거부할 권리가 있으나, 동의 거부 시 제2조에서 규정하고 있는 당사가 제공하는 서비스를 받을 수 없습니다
																	</li>
																	<li>
															...
															<li>
																<h3>제14조 고지의 의무</h3>
																<ol>
																	<li>현 개인정보처리방침은 2022년 10월 05일에 에 개정되었으며 정부의 정책 또는 보안기술의 변경에 따라 내용의 추가, 삭제 및 수정이 있을 시에는 개정 최소 7일 전부터 홈페이지를 통해 고지할 것입니다.</li>
										...
										<li>
											<h2>
												<div class="input_b size_sm type1 thirdparty">
													...
													<label for="chkChoiceAgreementForThirdPartyTelecomALL">제3자 마케팅 활용동의 <span style="font-size: 12px; color: #b1b1b1;">(선택)</span></label>
												</div>
											</h2>
										</li>
										<li>
								...
								<div class="input_b size_sm type1 thirdparty">
									<div class="ez-checkbox">
										<div class="ez-checkbox">
											<div class="ez-checkbox">
												<div class="ez-checkbox">
												<input name="chkChoiceAgreementForThirdPartyTelecomALL" type="checkbox" id="chkChoiceAgreementForThirdPartyTelecomALL" value="Y" 
													class="ez-hide thirdparty-parent" >
												</div>
											</div>
										</div>

									</div>
									<label for="chkChoiceAgreementForThirdPartyTelecomALL" style="position:absolute;">&nbsp;제3자 마케팅 활용동의 <span style="font-size: 12px; color: #b1b1b1;">(선택)</span></label>
								</div>
							</h2>--%>

						<%--	<h2 class="marketing_select">
								<div class="input_b size_sm type1 thirdparty">
									<div class="ez-checkbox">
										<div class="ez-checkbox"><div class="ez-checkbox">
											<input name="chkChoiceAgreementForThirdPartyShinhan" type="checkbox" id="chkChoiceAgreementForThirdPartyShinhan" value="119006" class="ez-hide thirdparty-child" runat="server"></div></div>

									</div>
									<label for="chkChoiceAgreementForThirdPartyShinhan" style="margin-left:-5px;position:absolute">&nbsp;&nbsp;금융</label>
								</div>
							</h2>--%>
							...
							<%--<h2 style="float:left;margin-left:40px">
								<div class="input_b size_sm type1 thirdparty">
									<div class="ez-checkbox">
										<div class="ez-checkbox"><div class="ez-checkbox">
											<div class="ez-checkbox">
											<input name="chkChoiceAgreementForThirdPartyTelecom" type="checkbox" id="chkChoiceAgreementForThirdPartyTelecom" value="119001" class="ez-hide thirdparty-child" runat="server"></div></div></div>
									</div>
									<label for="chkChoiceAgreementForThirdPartyTelecom">&nbsp;&nbsp;통신
										<a href="javascript:void(0);" onclick="openLayer('layerPop6')" class="close" style="padding:0 0 0 3px;text-decoration:none">
										<img src="/Resources/member/btn.svg"></a></label>
								</div>
							</h2>--%>
						</div>
						<div id="layerPop6" class="layerPop">
							...
							<div class="txt_a">
								...
								<div class="policy_a">
									...
									<!--
									<div>
										<h3>렌탈/통신 서비스 개인정보 제3자 제공</h3>
										<br>
										<span>개인정보를 제공받는자 : ㈜엘지헬로비전</span><br>
										<span>개인정보 제공항목 : 성명, 생년월일, 성별, 이메일, 참여일, 참여매체, 예식일정보</span><br>
										<span>개인정보 제공목적 : 전화, 문자, 이메일을 통한 엘지헬로비전 렌탈 및 통신상품 안내</span><br>
										<span>보유 및 이용기간 : 제공동의일로부터 1년 (고객동의 철회시 지체없이 파기)</span><br>
										<span>※ 동의를 거부하실 수 있으나, 이 경우 상품 안내 및 이벤트 참여가 제한됩니다.</span><br>
									</div>
									-->
                    ...
                    <!-- / 통신서비스 마케팅 활용 동의 -->
                    <!-- 개인정보 취급위탁동의 -->
                    <div id="wrapThirdPartyAgreement" class="term_b" style="position:relative; width:100%;/*padding-left:15px*/" runat="server">
							<h2>
								<div class="input_b size_sm type1">
									<div class="ez-checkbox">
										<div class="ez-checkbox">
											<div class="ez-checkbox">
												<input name="chkChoiceAgreementForThirdParty" type="checkbox" id="chkChoiceAgreementForThirdParty" value="Y" class="ez-hide agreement-thirdparty" runat="server">
											</div>
										</div>
									</div>
									<label for="chkChoiceAgreementForThirdParty">개인정보 처리 위탁 <span>(선택)</span>
										<a href="javascript:void(0);" onclick="openLayer('layerPop7')" class="close" <%--style="padding:0 0 0 10px;"--%>>
										<img src="/Resources/member/btn.svg"></a></label></div></h2>
								
								
								<div id="layerPop7" class="layerPop">
									<div class="are_wrap">
										<h3>개인정보 처리 위탁(선택)<a href="javascript:void(0);" onclick="closeLayer('layerPop7')" class="close">
											<img src="/Resources/member/ico-x.svg"></a>
										</h3>
									</div>
									<!-- 약관box -->
									<div class="txt_a">
					...
					<div style="margin:0 auto;">
						...
						<%--<div style=" overflow: hidden; width: 100%; background: #f9f9f9; padding: 20px 0; margin: 0 0 20px 0;">--%>
							<ul>
								<li style=" color: #d32f2f; float: left; padding:  0px 15px 0 18px;" <%-- style=" color: #d32f2f; float: left; padding:  0px 15px 0 18px;"--%>><img src="/Resources/member/info.svg" style="vertical-align: text-bottom; padding: 0 4px 0 0;">알고 계세요
								</li>

								<li style=" font-size: 13px; padding: 2px 0 0 0; text-align:left; overflow:hidden;" <%--style=" font-size: 13px; padding: 2px 0 0 0; text-align:left; overflow:hidden;"--%> class="ar-db">청첩장(10%) 및 감사장(15%) 할인쿠폰은 약관 전체 동의 시 발급됩니다.</li>
							<%--	<li style=" font-size: 13px; padding: 2px 0 0 0; text-align:left; overflow:hidden;">청첩장(10%) 및 감사장(15%) 할인쿠폰은 약관 전체 동의 시 발급됩니다.	--%>
							
							</ul>
						</div>
						  <asp:Literal ID="ltShinhanImg" runat="server"></asp:Literal>
						<%--<img src="https://www.barunnfamily.com/Resources/member/shinhan_p_bhands.jpg" style="width:100%;">--%>
						  <asp:Literal ID="ltKtImg" runat="server"></asp:Literal>
						<!-- 하단버튼 -->
						<div class="b_btn_a"  style="width:100%; height:55px; line-height:55px; background:#333; margin:20px 0 100px 0;" <%--style="width:100%; height:55px; line-height:55px; background:#333; margin:20px 0 100px 0;"--%>>
			...
			<%--				<a onclick="return Information.ValidationCheck();" id="LinkButton1" class="type2 right_Page02" href="javascript:__doPostBack('LinkButton1','')" style="color:#fff;"><span>가입완료</span></a>
			--%>			</div>
					</div>
                </div>
                <!-- / 바른손 동의 -->
			...
			<%--약관 원본 Start--%>
		   <%-- <div class="b_dtable_1 agreement_wrap check_all_area" style="display:none">
				<div class="agreeall_a clearfix" style="text-align:left;">
					<div class="input_b size_sm type1" style="float: inherit;"><div class="ez-checkbox"><input type="checkbox" name="checkbox_big1" class="check_all ez-hide" id="checkbox_big1_all"></div>
						<label for="checkbox_big1_all"><strong>모든 약관을 확인하고 전체 동의합니다.</strong></label>
					</div>
				...
				<div class="term_s barun_s">
					...
					<div class="samsung_s" id="wrapSamsungAgreement" runat="server">
						...
						<div class="term_b" style="float:left; width:100%;">
							...
							<div class="txt_a">
								<h2>
									<div class="input_b size_sm type1">
										<div class="ez-checkbox">
											<input type="checkbox" name="chkChoiceAgreementForSamSungMembership" id="chkChoiceAgreementForSamSungMembership" runat="server" value="Y" class="ez-hide agreement-samsung">
										</div>
										<label for="chkChoiceAgreementForSamSungMembership" style="font-weight:normal;">삼성전자 멤버십 회원 이용약관 <span>(선택)</span></label>
									</div>
								</h2>
							...
							<!-- 약관box -->
								...
								<!-- policy영역 -->
								<div class="policy_a">
										<h4><div class="input_b size_sm type1"><div class="ez-checkbox"><input type="checkbox" name="chkChoiceAgreementForSamSungPersonalData" id="chkChoiceAgreementForSamSungPersonalData" class="ez-hide agreement-samsung" runat="server"></div><label for="chkChoiceAgreementForSamSungPersonalData">필수적인 개인정보 수집 이용 동의 <span>(선택)</span></label></div></h4>
										<!--<h3>필수적인 개인정보 수집 이용 동의</h3>-->
										삼성전자 주식회사(이하 '삼성전자'라 합니다)는 최초 회원 가입 또는 서비스 이용 시 이용자로부터 아래와 같은 개인정보를 수집하고 있습니다. 개인정보 처리에 대한 상세한 사항은 삼성닷컴(https://www.samsung.com/sec/)에 공개한 '개인정보 처리방침'을 참조하십시오. 다만, 본 동의서 내용과 상충되는 부분은 본 동의서의 내용이 우선합니다. 귀하께서는 필수항목 수집·이용에 대한 동의를 거부하실 수 있으나, 이는 서비스 제공에 필수적으로 제공되어야 하는 정보이므로, 동의를 거부하실 경우 회원 가입 및 서비스 이용 등이 제한됩니다.
						...
						-	멤버십 혜택 제공 (포인트 적립 및 사용, 프리미엄 등급 혜택)
										...
										<h4><div class="input_b size_sm type1"><div class="ez-checkbox"><input type="checkbox" name="chkChoiceAgreementForSamSungPersonalData2" id="Checkbox6" class="ez-hide agreement-samsung" runat="server"></div><label for="chkChoiceAgreementForSamSungPersonalData2">선택적인 개인정보 수집 이용 동의 <span>(선택)</span></label></div></h4>
										<!--<h3>선택적인 개인정보 수집 이용 동의</h3>-->
										삼성전자 주식회사(이하 ‘삼성전자’라 합니다)는 최초 회원 가입 또는 서비스 이용 시 이용자로부터 아래와 같은 개인정보를 수집하고 있습니다. 귀하께서는 선택항목 수집·이용에 대한 동의를 거부하실 수 있으며, 이는 서비스 제공에 필수적으로 제공되어야 하는 정보가 아니므로 동의를 거부하시더라도 회원 가입, 서비스 이용, 홈페이지 이용 등이 가능합니다. 다만 선택항목 수집·이용에 대하여 동의하지 않으실 경우, 이벤트 참여 및 판촉 안내 등 서비스에 제한이 있을 수 있습니다.
										<ol>
											<li>
							...
							<!-- 약관box -->
								...
								<h2><div class="input_b size_sm type1"><div class="ez-checkbox"><input type="checkbox" name="chkChoiceAgreementForSamSungChoicePersonalData" id="chkChoiceAgreementForSamSungChoicePersonalData" value="Y" class="ez-hide agreement-samsung"  runat="server"></div><label for="chkChoiceAgreementForSamSungChoicePersonalData">삼성전자 멤버십 마케팅 정보 수신 <span>(선택)</span></label></div></h2>
										...
										<div>
											<ol>
												...
												<li>
													...
													<div class="input_b size_sm type1" style="margin: 10px 0 0px 21px;">
														<div class="ez-checkbox">
															<div class="ez-checkbox"><div class="ez-checkbox"><input name="chkChoiceAgreementForSamSungChoiceYearlData" type="checkbox" id="Checkbox1" value="R" class="ez-hide SamSungChoiceYear not-chk" runat="server" checked></div></div>
														</div>
														<label for="chkChoiceAgreementForSamSungChoiceYearlData" style="font-size: 14px;">삼성전자멤버십 탈퇴 시까지</label>
														  <span class="container disable-checkbox"><!--<div class="cover"></div>--><input type="checkbox" id="Checkbox2"  class="ez-hide SamSungChoiceYear not-chk" runat="server" value="5">5년  <input type="checkbox" id="Checkbox3"  class="ez-hide SamSungChoiceYear not-chk" runat="server" value="3">3년  <input type="checkbox" id="Checkbox4" class="ez-hide SamSungChoiceYear not-chk" runat="server" value="1">1년 으로 요청합니다.</span>
													</div>
												</li>
											</ol>
										</div>
							...
							<!-- 약관box -->
								...
								<h2><div class="input_b size_sm type1"><div class="ez-checkbox"><input type="checkbox" name="chkChoiceAgreementForSamSungThirdParty" id="chkChoiceAgreementForSamSungThirdParty" value="Y" class="ez-hide agreement-samsung"  runat="server"></div><label for="chkChoiceAgreementForSamSungThirdParty">삼성전자 멤버십 개인정보 제3자 제공 <span>(선택)</span></label></div></h2>
							...
							<!-- / 약관box -->
							<h2 style="text-align: left;"><div class="input_b size_sm type1"><div class="ez-checkbox"><input type="checkbox" name="chkChoiceAgreementForSamSungMembershipALL" id="chkChoiceAgreementForSamSungMembershipALL" value="Y" class="ez-hide agreement-samsung_main"  runat="server"></div><label for="chkChoiceAgreementForSamSungMembershipALL">삼성전자 멤버십 개인정보 제3자 제공 <span>(선택)</span><br /><span style="font-size:12px;">※ 회원약관, 필수적/선택적 개인정보 수집이용, 선택적 개인정보 제3자 제공, 마케팅 정보 수신에 동의합니다.</span></label></div></h2>
						</div>
						<!-- / 삼성전자 개인정보 제3자 제공 동의 -->
					...
					<!--%%%%%%%%%%%%%%%%%%%%%%%%%%%%%     20200702 회원약관 LG 추가     %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%-->
						<div class="term_b" style="width:100%;">
							...
							<div id="wrapLGAgreement" class="samsung_s" runat="server">
								<!-- / LG전자 전체 동의 그룹-->
								<div style="margin: 0 auto; border: 1px solid #ddd; background: #f9f9f8; height: 85px; overflow-x: hidden;">
								...
								<h2>
									<div class="input_b size_sm type1">
										...
										<label for="chkChoiceAgreementForLGMembershipALL" style="margin: 0 0 0 -6px;	">LG전자 멤버십 전체 이용 약관 동의<span>(선택)</span></label>
									</div>
								</h2>
							</div>
						</div>
						...
						<!-- 까사미아 동의 20211130 추가 -->
						<div class="term_b" style="width:100%;">
							<div id="wrapCsAgreement" class="samsung_s">
								<div style="width: 99%; margin: 0 auto; border: 1px solid #ddd; background: #f9f9f8; height: 85px; overflow-y: scroll; overflow-x: hidden;">
									<div>
										<div class="input_b size_sm type1" style="margin: 10px 0 0px 21px;">
											<div class="ez-checkbox">
												<div class="ez-checkbox"><div class="ez-checkbox"><div class="ez-checkbox"><input name="chkChoiceAgreementForCasamiaMembership" type="checkbox" id="chkChoiceAgreementForCasamiaMembership" value="Y" class="ez-hide agreement-casa" runat="server"></div></div></div>
											</div>
											<label for="chkChoiceAgreementForCasamiaMembership" style="font-size: 14px;">까사미아 서비스 이용약관 <span>(선택)</span></label>
										</div>
										<!-- 약관box -->
									...
									<div>
										<h2>
											<div class="input_b size_sm type1">
												<div class="ez-checkbox">
													<input name="chkChoiceAgreementForCasamiaMembership2" type="checkbox" id="chkChoiceAgreementForCasamiaMembership2" class="ez-hide agreement-casa" runat="server">
												</div>
												<label for="chkChoiceAgreementForCasamiaMembership2">까사미아 위치정보서비스 활용동의 <span>(선택)</span></label>
											</div>
										</h2>
									...
									<div>
										<h2>
											<div class="input_b size_sm type1">
												<div class="ez-checkbox">
													<input name="chkChoiceAgreementForCasamiaMembership3" type="checkbox" id="chkChoiceAgreementForCasamiaMembership3" class="ez-hide agreement-casa" runat="server">
												</div>
												<label for="chkChoiceAgreementForCasamiaMembership3">까사미아 개인정보 처리방침<span>(선택)</span></label>
											</div>
										</h2>
									...
									<div>
										<h2>
											<div class="input_b size_sm type1">
												<div class="ez-checkbox">
													<input name="chkChoiceAgreementForCasamiaMembership4" type="checkbox" id="chkChoiceAgreementForCasamiaMembership4" class="ez-hide agreement-casa" runat="server">
												</div>
												<label for="chkChoiceAgreementForCasamiaMembership4">까사미아 영상정보처리기기 운영 관리 방침 <span>(선택)</span></label>
											</div>
										</h2>
								...
								<h2 style="text-align: left;">
									<div class="input_b size_sm type1">
										<div class="ez-checkbox">
											<div class="ez-checkbox"><div class="ez-checkbox"><div class="ez-checkbox"><input name="chkChoiceAgreementForCasamiaMembershipALL" type="checkbox" id="chkChoiceAgreementForCasamiaMembershipALL" value="Y" class="ez-hide agreement-casa" runat="server"></div></div></div>
										</div>
										<label for="chkChoiceAgreementForCasamiaMembershipALL" style="position:absolute;margin: 0 0 0 2px;">까사미아 멤버십 전체 이용약관 동의<span>(선택)</span></label>
									</div>
								</h2>
							</div>
						</div>
					...
					<!-- 통신서비스 마케팅 활용 동의 -->
					<div class="term_b" style="float:left; width:100%;"  id="wrapThirdPartyAgreementTelecom" runat="server">
						<!-- 약관box -->
					...
					<!-- 개인정보 취급위탁동의 -->
					<div class="term_b"  id="wrapThirdPartyAgreement" runat="server" style="float:left; width:100%;" >
						<!-- 약관box -->
						<div class="txt_a">
							<!-- policy영역 -->
							<div class="policy_a">
					...
					<!-- 하단 유의사항 추가영역-->
					<style>
						.bt_info {text-align: left; margin: 28px 10px 30px 6px; display: block; overflow:hidden; border: 1px solid #fff;}
						.bt_info h3 {font-size:14px; margin:0;color: #000; border:0; padding: 0 0 15px 0;}
					...
					<div class="bt_info">
						<h3>※ 약관 전체 동의(선택 동의 포함) 시, 할인쿠폰이 발급됩니다.<span style="color:#2e96ff">(청첩장 10% 할인 쿠폰, 감사장 15%할인 쿠폰)</span></h3>
						<ul>
        ...
        <%--    <div class="b_btn_a">--%>
             ...
             <%--   <asp:LinkButton ID="LinkButton1" CssClass="b_btn type2 right_Page02" runat="server" OnClick="btnSave_Click" OnClientClick="return Information.ValidationCheck();"><span>가입완료하기</span></asp:LinkButton>
            --%><%--</div>--%>
            <!-- / 하단버튼 -->
        </div>
        <!-- / 기본 정보입력 -->
