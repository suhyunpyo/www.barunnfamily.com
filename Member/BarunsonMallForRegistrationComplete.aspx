<%@ Page Title="" Language="C#" MasterPageFile="~/Master/SiteOne.Master" AutoEventWireup="true" CodeBehind="BarunsonMallForRegistrationComplete.aspx.cs" Inherits="BarunnIntergrationService.Member.BarunsonMallForRegistrationComplete" %>
     ...
     <script language='javascript'>
         ...
         if (MobileYN == "N") {
            ...
            var m_jid = "<%=sUserId%>";     // 회원가입 - 회원아이디
             ...
             var _AceGID = (function () { var Inf = ['m.barunsonmall.com', 'm.barunsoncard.com', 'AZ3A72533', 'AM', '0', 'NaPm,Ncisy', 'ALL', '0']; var _CI = (!_AceGID) ? [] : _AceGID.val; var _N = 0; if (_CI.join('.').indexOf(Inf[3]) < 0) { _CI.push(Inf); _N = _CI.length; } return { o: _N, val: _CI }; })();
