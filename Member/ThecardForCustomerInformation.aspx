<%@ Page Title="" Language="C#" MasterPageFile="~/Master/SiteOne.Master" enableEventValidation="false" AutoEventWireup="true" CodeBehind="ThecardForCustomerInformation.aspx.cs" Inherits="BarunnIntergrationService.Member.ThecardForCustomerInformation" ClientIDMode="Static" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <link href="/resources/css/Member/ThecardForCustomerInformation.css" rel="stylesheet">
    ...
    <script type="text/javascript" src="/resources/js/Member/ThecardForCustomerInformation.js"></script>
	...
	<div class="cont_a">
		...
		<div class="cont_a_in">
   				...
   				<dl id="dlWeddingDayField" runat="server">
					...
					<dd>
                        <div class="input-group date">
						    ...
						    <a href="javascript:;" class="input-group-addon btnCalendarIcon"><img src="/resources/img_inc/icon_calender_thecard.png" alt="달력버튼"></a>
                        </div>
					</dd>
				</dl>
			...
			<div class="term_s barun_s">
				...
				<div class="term_b" style="float:left; width:50%;">
					<!-- 약관box -->
					<div class="txt_a">
						<!-- policy영역 -->
						<div class="policy_a">
					...
					<div class="term_b">
						...
						<div id="wrapLGAgreement" class="samsung_s" runat="server">
							...
							<h2>
								<div class="input_b size_sm type1">
									<div class="ez-checkbox">
										<div class="ez-checkbox"><div class="ez-checkbox"><input name="chkChoiceAgreementForLGMembershipALL" type="checkbox" id="chkChoiceAgreementForLGMembershipALL" value="Y" class="ez-hide agreement-lg"></div></div>
									</div>
									...
									<div class="txt_a_new" style="">
										...
										<div class="policy_a">
												...
												<ol>
													...
													<li>⑧ “제휴사”(이하 '제휴사'라 함)란 당사와 “사이트” 운영과 관련하여 제휴 계약을 맺고 서비스를 공동 제공하기로 합의한 회사로서 당해 회사의 영업점포 (이하 '제휴영업점'이라 함) 및 인터넷 사이트(이하 '사이트'이라 함)를 포함합니다. 추후 제휴사는 “사이트”의 사정에 따라 추가 또는 서비스 계약 해지 될 수 있으며 신세계까사 Guud members  굳멤버스 홈페이지(https://guudmembers.casamia.co.kr)를 통해 고지 합니다.</li>
