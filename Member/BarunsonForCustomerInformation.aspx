<%@ Page Title="" Language="C#" MasterPageFile="~/Master/SiteOne.Master" AutoEventWireup="true" enableEventValidation="false" CodeBehind="BarunsonForCustomerInformation.aspx.cs" Inherits="BarunnIntergrationService.Member.BarunsonForCustomerInformation" ClientIDMode="Static" %>
		...
		<div class="cont_a_in">
		    ...
		    <div class="b_dtable_1 agreement_wrap check_all_area">
			    ...
			    <div class="term_s barun_s"  style="margin: 2px 0 0 0;">
			        ...
			        <!-- 삼성전자 동의 -->
                   <%-- <div class="term_b samsung_s"  style="display: none">
			            <div class="samsung_s" id="wrapSamsungAgreement" runat="server" >
                            ...
                            <h2 style="overflow: hidden;text-align: left;	margin: 19px 0 1px 1px;">
                                <div class="input_b size_sm type1">
                                    ...
                                    <label for="chkChoiceAgreementForSamSungMembershipALL" style="position:absolute; margin-left:1px;">삼성전자 멤버십 전체 동의<span>(선택)</span>&nbsp;&nbsp;<span style="font-size:12px;">※ 회원약관, 필수적/선택적 개인정보 수집이용, 선택적 개인정보 제3자 제공, 마케팅 정보 수신에 동의합니다.</span></label>
                                </div>
				            </h2>
                                                            ...
                                                            <div class="input_b size_sm type1" style="margin: 10px 0 0px 21px;">
										                        ...
										                        <label for="chkChoiceAgreementForSamSungChoiceYearlData" style="font-size: 14px;">삼성전자멤버십 탈퇴 시까지</label>
                                                                  <span class="container disable-checkbox">
                                                                      <!--<div class="cover"></div>-->
                                                                      <input name="chkChoiceAgreementForSamSungChoiceYearlData" type="checkbox" id="Checkbox2"  class="ez-hide SamSungChoiceYear not-chk" runat="server" value="5">5년  <input name="chkChoiceAgreementForSamSungChoiceYearlData" type="checkbox" id="Checkbox3"  class="ez-hide SamSungChoiceYear not-chk" runat="server" value="3">3년  <input name="chkChoiceAgreementForSamSungChoiceYearlData" type="checkbox" id="Checkbox4" class="ez-hide SamSungChoiceYear not-chk" runat="server" value="1">1년 으로 요청합니다.
					...
					<!-- KT 동의 20220329 추가 -->
					<div id="wrapKtAgreement" class="samsung_s">
						<h2 id="KtAgreement1" style="overflow: hidden;text-align: left;	margin: 19px 0 13px 5px;" runat="server" visible="false">
							<div class="input_b size_sm type1">
								<div class="ez-checkbox">
									<div class="ez-checkbox"><div class="ez-checkbox"><div class="ez-checkbox"><input name="chkChoiceAgreementForKtMembership" type="checkbox" id="chkChoiceAgreementForKtMembership" value="Y" class="ez-hide agreement-kt" runat="server"></div></div></div>
								</div>
								<label for="chkChoiceAgreementForKtMembership" style="position:absolute;margin: 0 0 0 2px;">KT 마케팅 활용 동의<span>(선택)</span></label>
							</div>
						</h2>


						<div id="KtAgreement2"  runat="server" visible="false" style="width: 99%; margin: 0 auto; border: 1px solid #ddd; background: #f9f9f8;  height: 185px; /*height: 85px; */overflow-y: scroll; overflow-x: hidden;">
								...
								<div class="txt_a txt_a_new" style="width: 94%; border:1px solid #f9f9f8; ">
									...
									<div class="policy_a">
                                        <h3>개인정보를 제공받는 자: KT</h3>
                                            <ol>
                                                <li>개인정보 제공 목적: 전화를 이용한 KT 및 제휴사 상품,서비스 안내 및 판매, 그 외 문자, 이메일 등을 이용한 할인/사은/판촉행사 혜택 등 정보 제공</li>
                                                <li>&nbsp;</li>
                                                <li>개인정보 제공 항목: CI값, 성명, 생년월일, 성별, 전화번호, 핸드폰번호, 주소, 이메일주소, 예식일, “바른컴퍼니” 회원가입일, 동의일시, 동의매체 등</li>
                                                <li>&nbsp;</li>
                                                <li>정보 보유 및 이용기간: 제공 동의일로부터 1년 (고객동의 철회 시 지체 없이 파기)</li>
												<li>&nbsp;</li>
												<li>※ KT는 전화, 문자를 통한 상품/서비스 안내 및 판매 등 마케팅 업무 등을 KTIS, KTCS,  KT m&s 에게 위탁합니다. </li>
                                                <li>&nbsp;</li>
...
<%--                                                <li>&nbsp;</li>
					...
					<!-- KT 동의 20220329 추가 -->
						...
						<!-- 20220426 표수현 현대백화점 신촌점 약관 시작--> 
					<div id="wrapHyundai_Agreement" class="Hyundai_s" runat="server" visible="false">
							...
							<h2 style="overflow: hidden;text-align: left;margin: 19px 0 13px 5px;">
                                <div class="input_b size_sm type1">
                                    <div class="ez-checkbox">
                                        <div class="ez-checkbox">
                                            <div class="ez-checkbox">
                                                <input name="chkChoiceAgreementForHyundaiALL" type="checkbox" id="chkChoiceAgreementForHyundaiALL" value="Y" class="ez-hide agreement-Hyundai" runat="server" />
											</div>

                                        </div>
                                    </div>
                                    <label for="chkChoiceAgreementForHyundaiALL" style="position: absolute; margin: 0 0 0 2px;">현대백화점 신촌점 약관 동의<span>(선택)</span></label>
                                </div>
							</h2>
								...
								<%--	<div class="input_b size_sm type1" style="margin: 10px 0 -6px 0px;">
										<div class="ez-checkbox">
											<div class="ez-checkbox"><div class="ez-checkbox">
												<input name="chkChoiceAgreementForHyundai" type="checkbox" id="chkChoiceAgreementForHyundai" value="Y" class="ez-hide agreement-Hyundai"  runat="server"></div></div>
										</div>
										<label for="chkChoiceAgreementForHyundai" style="font-size: 14px;">쇼핑서비스 개인정보 제3자 제공
</label>
									</div>--%>
									<!-- 약관box -->
									<div class="txt_a txt_a_new" style="width: 94%; border:1px solid #f9f9f8; ">
										<!-- policy영역 -->
										<div class="policy_a">
												<h3>개인정보를 제공받는 자: 현대백화점 신촌점</h3>
												<ol>
													<li>개인정보 제공 목적: 전화를 이용한 현대백화점 신촌점 상품,서비스 안내 및 판매, 그 외 문자, 이메일을 이용한 할인/사은/판촉행사 등 정보 제공</li>
													     <li>&nbsp;</li>
													<li>개인정보 제공 항목: 성명,휴대폰번호,생년월일,성별,주소,이메일,예식일,동의일시,동의매체</li>
													     <li>&nbsp;</li>
													<li>개인정보 보유 및 이용기간: 제공 동의일로부터 1년 (고객동의 철회 시 지체없이 파기)</li>
													     <li>&nbsp;</li>
													<li>※ 위와 같은 본인의 개인정보 수집, 이용에 관한 동의를 거부할 권리가 있습니다. 단, 동의 거부 시 상품 정보 제공 및 혜택 안내 제한
												</ol>
										</div>
										<!-- / policy영역 -->
									</div>
                ...
                <!--200330 수정영역-->
				<p style="padding:32px 0 0 7px; text-align:left;">
                    <asp:Literal ID="ltKtImg" runat="server"></asp:Literal>
				</p>
				<p style="padding:12px 0 0 7px; text-align:left;">
