...
function foldDaumPostcode() {
    ...
    document.getElementById('wrapPostCode').style.display = 'none';
    document.getElementById('wrapPostCode').style.position = 'fixed';
}
...
(function ($) {
    ...
    $.fn.postcode = function () {
        ...
        var wrapPostCode = document.getElementById('wrapPostCode');
        ...
        daum.postcode.load(function () {
            ...
            new daum.Postcode({
                oncomplete: function (data) {
                    ...
                    wrapPostCode.style.display = 'none';
                    wrapPostCode.style.position = 'fixed';
                    // 우편번호 찾기 화면이 보이기 이전으로 scroll 위치를 되돌린다.
                    document.body.scrollTop = currentScroll;

                },
                onresize: function (size) {
                    wrapPostCode.style.height = size.height + 'px';
                },
                width: '100%',
                height: '100%'
            }).embed(wrapPostCode);
            ...
            wrapPostCode.style.position = 'relative';
        });
