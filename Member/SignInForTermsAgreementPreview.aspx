<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Site.Master" AutoEventWireup="true" CodeBehind="SignInForTermsAgreementPreview.aspx.cs" Inherits="BarunnIntergrationService.Member.SignInForTermsAgreementPreview" ClientIDMode="Static" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style>
        ...
        .term_s .term_b {padding-bottom: 20px;}
	...
	<div class="cont_a">
		<div class="cont_a_in check_all_area">
			...
			<div class="term_s barun_s">
				...
				<div class="term_b">
					<h2><div class="input_b size_sm type1"><input type="checkbox" name="chkEssentialAgreement" id="chkEssentialAgreement" value="Y"><label for="chkEssentialAgreement">이용약관 동의 <strong>(필수)</strong></label></div></h2>
					<!-- 약관box -->
					<div class="txt_a">
						<!-- policy영역 -->
						<div class="policy_a">
				...
				<div class="term_b">
					<h2><div class="input_b size_sm type1"><input type="checkbox" name="chkEssentialAgreementPurpose" id="chkEssentialAgreementPurpose" value="Y"><label for="chkEssentialAgreementPurpose">개인정보 수집 이용 동의 <strong>(필수)</strong></label></div></h2>
					<!-- 약관box -->
					<div class="txt_a">
						<!-- policy영역 -->
						<div class="policy_a">
			...
			<div class="term_s samsung_s" id="wrapSamsungAgreement" runat="server">
                ...
                <!-- 삼성전자 멤버십 회원 이용 약관 -->
				<div class="term_b">
					<h2><div class="input_b size_sm type1"><input type="checkbox" name="chkChoiceAgreementForSamSungMembershipAll" id="chkChoiceAgreementForSamSungMembershipAll"><label for="chkChoiceAgreementForSamSungMembershipAll">삼성전자 멤버십 가입 동의 <span>(선택)</span></label></div></h2>
					<!-- 약관box -->
					<div class="txt_a">
                        <!-- policy영역 -->
			...
			-	멤버십 혜택 제공 (포인트 적립 및 사용, 프리미엄 등급 혜택)
						...
						<p><br>삼성전자 주식회사(이하 ‘삼성전자’라 합니다)는 최초 회원 가입 또는 서비스 이용 시 이용자로부터 아래와 같은 개인정보를 수집하고 있습니다. 귀하께서는 선택항목 수집·이용에 대한 동의를 거부하실 수 있으며, 이는 서비스 제공에 필수적으로 제공되어야 하는 정보가 아니므로 동의를 거부하시더라도 회원 가입, 서비스 이용, 홈페이지 이용 등이 가능합니다. 다만 선택항목 수집·이용에 대하여 동의하지 않으실 경우, 이벤트 참여 및 판촉 안내 등 서비스에 제한이 있을 수 있습니다.</p>
							<div>
								<ol>
									...
									※ 제휴사는 회사와 고객에 대한 상품 및 서비스 안내 등과 관련하여 제휴 계약을 체결한 자를 의미합니다.<br>
									</li>
									<li>
									<h3>수집목적</h3>
									<table border="0" cellspacing="0" cellpadding="0" class="header_h">
                                    ...
                                    <li>
							            ...
							            <table border="0" cellspacing="0" cellpadding="0" class="header_h">
								            ...
								            <tr>
									            ...
									            <td><p align="left">㈜한국리서치, 마크로밀엠브레인, 닐슨컴퍼니코리아 유한회사</p></td>
									            <td><p align="left">제품 소비자 만족도 및 사용행태 조사</p></td>
								            </tr>
								            <tr>
									            <td width="500px;"><p align="left">제일기획㈜ 및 협력사<a href="http://membership.samsung.com/sec/PopCheillInfo" onclick="window.open(this.href, 'mywin','left=20,top=20,width=480,height=500,esizable=no,status=no,scrollbars=no,menubar=no'); return false;">(목록보기)</a>, ㈜지엠컴, (주)제3채널, (주)코리오), (주)에프엠커뮤니케이션즈, 포유비즈 및 협력사(아이크레티브, (주)한국그래픽스, 타임CC 및 협력사(슈어엠), (주)마크로밀엠브레인, 삼성전자서비스(주), (주)싸스컴, (주)지오그라픽스, (주)대경엠앤씨, (주)데이타존, 대성전산(주), 빌포스트(주), 인포뱅크(주), ㈜케이디뱅크, 주식회사 디메이크</p></td>
				...
				<div class="term_b" style="float:left; width:50%;">
					<h2><div class="input_b size_sm type1"><input type="checkbox" name="chkChoiceAgreementForSamSungMembership" id="chkChoiceAgreementForSamSungMembership" value="Y"><label for="chkChoiceAgreementForSamSungMembership">삼성전자 멤버십 회원 이용약관 <span>(선택)</span><a href="#none" class="detail">보기</a></label></div></h2>
					<!-- 약관box -->
					<div class="txt_a" style="display:none;">
						<!-- policy영역 -->
						<div class="policy_a">
							<h3>제1장 총칙</h3>
							<h3>제1조 (목적)</h3>
				...
				<!-- 삼성전자 개인정보 수집 이용 동의 -->
				<div class="term_b">
					<h2><div class="input_b size_sm type1"><input type="checkbox" name="chkChoiceAgreementForSamSungPersonalData" id="chkChoiceAgreementForSamSungPersonalData" value="Y"><label for="chkChoiceAgreementForSamSungPersonalData">삼성전자 멤버십 개인정보 수집 이용 동의 <span>(선택)</span><a href="#none" class="detail">보기</a></label></div></h2>
					<!-- 약관box -->
										<div class="txt_a" style="display:none;">
						<!-- policy영역 -->
						<div class="policy_a">
			...
			-	멤버십 혜택 제공 (포인트 적립 및 사용, 프리미엄 등급 혜택)
				...
				<div class="term_b" style="float:left; width:50%;">
					<h2><div class="input_b size_sm type1"><input type="checkbox" name="chkChoiceAgreementForSamSungChoicePersonalData" id="chkChoiceAgreementForSamSungChoicePersonalData" value="Y"><label for="chkChoiceAgreementForSamSungChoicePersonalData">삼성전자 멤버십 선택적 개인정보 수집 이용 동의 <span>(선택)</span><a href="#none" class="detail">보기</a></label></div></h2>
					<!-- 약관box -->
					<div class="txt_a" style="display:none;">
						<!-- policy영역 -->
						<div class="policy_a">
							...
							<table border="0" cellspacing="0" cellpadding="0" class="header_h">
								...
								<tr>
									<td width="500px;"><p align="left">제일기획㈜ 및 협력사<a href="http://membership.samsung.com/sec/PopCheillInfo" onclick="window.open(this.href, 'mywin','left=20,top=20,width=480,height=500,esizable=no,status=no,scrollbars=no,menubar=no'); return false;">(목록보기)</a>, ㈜지엠컴, (주)제3채널, (주)에프엠커뮤니케이션즈, 포유비즈 및 협력사(아이크레티브, (주)한국그래픽스, 타임CC 및 협력사(슈어엠), (주)마크로밀엠브레인, 삼성전자서비스(주), (주)싸스컴, (주)지오그라픽스, (주)대경엠앤씨, (주)데이타존, 대성전산(주), 빌포스트(주), 인포뱅크(주), ㈜케이디뱅크, 주식회사 디메이크</p></td>
									<td><p align="left">이벤트 대행 및 이벤트 문의 처리, 이벤트 관련 고지, 경품배송, DM발송, TM, 프로모션 대행 업무, 제세공과금처리</p></td>
								</tr>						
							</tbody></table>
							<!-- / 160902 수정1 -->	
				...
				<!-- 삼성전자 개인정보 제3자 제공 동의 -->
				<div class="term_b">
					<h2><div class="input_b size_sm type1"><input type="checkbox" name="chkChoiceAgreementForSamSungThirdParty" id="chkChoiceAgreementForSamSungThirdParty" value="Y"><label for="chkChoiceAgreementForSamSungThirdParty">삼성전자 멤버십 개인정보 제3자 제공 동의 <span>(선택)</span><a href="#none" class="detail">보기</a></label></div></h2>
					<!-- 약관box -->
					<div class="txt_a" style="display:none;">
						<!-- policy영역 -->
						<div class="policy_a">
			...
			<!-- / 삼성전자 동의 170426 -->
                ...
                <!-- 통신분야 마케팅활용동의 -->
				<div class="term_b b_clear" id="wrapThirdPartyAgreementTelecom" runat="server">
					<h2><div class="input_b size_sm type1"><input type="checkbox" name="chkChoiceAgreementForThirdPartyTelecom" id="chkChoiceAgreementForThirdPartyTelecom" value="119001"><label for="chkChoiceAgreementForThirdPartyTelecom">통신분야 마케팅 활용동의 <span>(선택)</span></label></div></h2>
					<!-- 약관box -->
					<div class="txt_a">
						<!-- policy영역 -->
						<div class="policy_a">
							...
							<div>
								<ul class="type_num">
									...
									<li>2. 회사는 개인정보처리방침을 통하여 귀하께서 제공하시는 개인정보가 어떠한 용도와 방식으로 이용되고 있으며 개인 정보보호를 위해 어떠한 조치가 취해지고 있는지 알려드립니다.</li>
								...
								<colgroup>
									...
									<tr>
										...
										<td>성명, 휴대폰번호, 생년월일, 성별, 이메일, 예식일, 참여일시</td>
										<td>전화, 문자, 이메일을 이용한 SK브로드밴드의 통신상품 및 SK텔레콤의 스마트홈 서비스 상품 소개/판매 ※멤플러스 : 마케팅 위탁 운영 대행</td>
										<td>제공동의일로부터 1년</td>
									</tr>
								</table>
							<ul class="type_num">
									<li>제3자 정보제공의 동의 철회</li>
									<li>1. 마케팅 활용동의를 통해 이미 제공된 회원정보에 대해 동의 철회를 요청하시는 경우, 동의상태 변경 또는 철회 요청일로부터 15일 이내에, 회원님의 정보는 기술적인 방법으로 복구 불가하도록 안전하게 철회 및 삭제처리 됩니다. 동의 철회를 원하시는 경우 아래 민원처리센터로 연락 주시기 바랍니다. 개인정보관련 의견수렴 및 불만처리에 관한 사항회사는 회원님과의 원할한 의사소통을 위해 민원처리센터를 운영하고 있으며 연락처는 다음과 같습니다.</li>
									<br/>
									<li>[민원처리센터]</li>
									...
									<br/>
									<li>고객님께서는 동의를 거부하실 수 있으며, 동의 거부 시 회원가입은 가능하나, 각종 광고 및 이벤트 안내 등의 서비스가 제한됩니다.</li>
									<br/>
									<li>※ 파트너사(제공받는자)는 본 마케팅 활용동의에 동의하신 회원대상 당사의 인프라 사용에 따른 비용을 지급하고 있으며, 동의하지 않으셔도 서비스 이용에는 제한 없습니다.</li>
								</ul>	
							</div>
                ...
                <!-- 보험분야 마케팅활용동의 -->
				<div class="term_b" id="wrapThirdPartyAgreementInsurance" runat="server">
					<h2><div class="input_b size_sm type1"><input type="checkbox" name="chkChoiceAgreementForThirdPartyInsurance1" id="chkChoiceAgreementForThirdPartyInsurance1" value="119002"><label for="chkChoiceAgreementForThirdPartyInsurance1">보험분야 마케팅 활용동의 <span>(선택)</span></label></div></h2>
					<!-- 약관box -->
					<div class="txt_a">
						<!-- policy영역 -->
						<div class="policy_a">
							...
							<div>
								...
								<colgroup>
									...
									<tr>
										<td>㈜라이나금융서비스, 라이나생명(보험가입 여부 확인에 한함)</td>
										<td>성명, 주소, 전화번호, 휴대폰번호, 생년월일, 성별, 이메일</td>
										<td>전화, 문자, 이메일을 이용한 라이나생명 보험상품 권유 및 이를 위한 보험가입 여부 확인(라이나금융서비스가 라이나생명에 성명/휴대폰번호로 보험가입 여부만 확인하는 방식)</td>
										<td>제공동의일로부터 1년</td>
									</tr>
								</table>
							</div>
                ...
                <!-- 개인정보 취급위탁동의 -->
				<div class="term_b b_mb40" id="wrapThirdPartyAgreement" runat="server">
					<h2><div class="input_b size_sm type1"><input type="checkbox" name="chkChoiceAgreementForThirdParty" id="chkChoiceAgreementForThirdParty" value="Y"><label for="chkChoiceAgreementForThirdParty">개인정보 취급위탁동의 <span>(선택)</span><a href="#none" class="detail">보기</a></label></div></h2>
					<!-- 약관box -->
					<div class="txt_a" style="display:none; height:60px; overflow:hidden;">
						<!-- policy영역 -->
						<div class="policy_a">
							<h3>[개인정보 취급위탁동의]</h3>
							<div>
								<ul class="type_num">
									<li>수탁자 : ㈜멤플러스, 수탁업무 : 분야별 마케팅활용 동의회원 개인정보 처리 및 바른라이프(금융,통신,멤버십 등) 제휴상품 추천,안내</li>
								</ul>
							</div>
						</div>
						<!-- / policy영역 -->
