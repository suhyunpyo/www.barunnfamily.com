<%@ Page Title="" Language="C#" MasterPageFile="~/Master/SiteOne.Master" AutoEventWireup="true" CodeBehind="BarunsonMcardForCustomerInformation.aspx.cs" Inherits="BarunnIntergrationService.Member.BarunsonMcardForCustomerInformation" %>
		    ...
		    <div class="b_dtable_1 agreement_wrap check_all_area">
			    ...
			    <div class="term_s barun_s"  style="margin: 2px 0 0 0;">
				    ...
				    <div class="term_b" style="width:100%;">
					    <h2 style="margin-bottom:0;"><div class="input_b size_sm type1"><div class="ez-checkbox"><input type="checkbox" name="chkEssentialAgreement" id="chkEssentialAgreement" value="Y" class="ez-hide"></div><label for="chkEssentialAgreement" runat="server">이용약관 동의 <span>(필수)</span></label></div></h2>
					    ...
					    <div class="txt_a">
							...
							<p style="margin-top:14px;"><a href="/Member/MemberPolicyHistory.aspx?div=U" class="policy_button" target="_blank">이전 약관 내용 보기</a></p>
					    </div>
					    <!-- / 약관box -->
				    </div>
				    <!-- / 바른컴퍼니 바른 ONE 서비스 이용약관동의 -->
				    ...
				    <!-- 개인정보 수집 이용 동의 -->
				    <div class="term_b" style="width:100%;">
					    <h2 style="margin-bottom:0;"><div class="input_b size_sm type1"><div class="ez-checkbox"><input type="checkbox" name="chkEssentialAgreementPurpose" id="chkEssentialAgreementPurpose" value="Y" class="ez-hide"></div><label for="chkEssentialAgreementPurpose">개인정보 수집 이용 동의 <span>(필수)</span></label></div></h2>
					    ...
					    <div class="txt_a">
							...
							<p style="margin-top:14px;"><a href="/Member/MemberPolicyHistory.aspx?div=P" class="policy_button" target="_blank">이전 약관 내용 보기</a></p>
					    </div>
					    <!-- / 약관box -->
				    </div>
				    <!-- / 개인정보 수집 이용 동의 -->
