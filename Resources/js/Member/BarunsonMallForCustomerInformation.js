var Information = {
    ...
    events: function () {
        ...
        $(".datepicker").datepicker({
            ...
            dateFormat: "yy-mm-dd",
            showOn: "both",
            buttonImage: "/resources/img_inc/icon_calender.png"
    ...
    ValidationCheck: function () {
        ...
        //if (isValidation && $("#chkChoiceAgreementForLGMembershipALL").is(":checked") == false) { // 전체 선택 안하고
        //    if ($("#chkChoiceAgreementForLGMembership").is(":checked") == true || $("#chkChoiceAgreementForLGChoicePersonalData").is(":checked") == true) {
        //        LGSelectChk = "Y";
        //    }
        //}
        ...
        //if (isValidation && $("#chkChoiceAgreementForCasamiaMembershipALL").is(":checked") == false) { // 전체 선택 안하고
        //    if ($("#chkChoiceAgreementForCasamiaMembership").is(":checked") == true || $("#chkChoiceAgreementForCasamiaMembership2").is(":checked") == true || 
        //        $("#chkChoiceAgreementForCasamiaMembership3").is(":checked") == true || $("#chkChoiceAgreementForCasamiaMembership4").is(":checked") == true)
        //    {
        //        CasamiaSelectChk = "Y";
        //    }
        //}
        ...
        //if (isValidation && $("#chkChoiceAgreementForThirdPartyTelecomALL").is(":checked") == false) { // 전체 선택 안하고
        
        //        if ($("#chkChoiceAgreementForThirdPartyShinhan").is(":checked") == true || $("#chkChoiceAgreementForThirdPartyTelecom").is(":checked") == true) {
        //            AgreementForThirdPartySelectChk = "Y";
        //    }
        //}
        ...
        //if (LGSelectChk == "N" || CasamiaSelectChk == "N" || AgreementForThirdPartySelectChk == "N" || AgreementForThirdParty == "N") { //모든 선택약관에서 부분 동의 체크가 하나라도 없을 경우
        //alert($("#confirm_chk").val());

        if ((LGSelectChk == "N" || CasamiaSelectChk == "N" || AgreementForThirdPartySelectChk == "N" || AgreementForThirdParty == "N")  && $("#confirm_chk").val() == "N") { //모든 선택약관에서 부분 동의 체크가 하나라도 없을 경우

            var result = confirm("이용약관 전체 동의 시 쿠폰이 발급됩니다.\n전체 동의하고 쿠폰을 받으시겠습니까 ?");

            if (result) {
                //약관 전체 동의 체크 
                $("#checkbox_big1_all").trigger("click");
                //$("#chkChoiceAgreementForLGMembership").prop('checked', true);
                //$("#chkChoiceAgreementForLGChoicePersonalData").prop('checked', true);
                //$("#chkChoiceAgreementForCasamiaMembership").prop('checked', true);
                //$("#chkChoiceAgreementForCasamiaMembership2").prop('checked', true);
                //$("#chkChoiceAgreementForCasamiaMembership3").prop('checked', true);
                //$("#chkChoiceAgreementForCasamiaMembership4").prop('checked', true); 
                isValidation = false;
                }
            else {
                isValidation = false;
...
$(function () {
    ...
    $(".ez-checkbox input:checkbox:not('.check_all')").click(function () {
        ...
        if ($(this).attr("id") == "chkAgeAgreement" || $(this).attr("id") == "chkEssentialAgreement" || $(this).attr("id") == "chkEssentialAgreementPurpose" ||
            ...
            if ($(this).is(':checked')) {
                ...
                if ($(this).attr("id") == "chkChoiceAgreementForThirdPartyTelecomALL" || $(this).attr("id") == "chkChoiceAgreementForThirdPartyShinhan" || $(this).attr("id") == "chkChoiceAgreementForThirdPartyTelecom" || $(this).attr("id") == "chkChoiceAgreementForThirdParty") //금융 체크
                {
                    $("#chkChoiceAgreementForThirdPartyTelecomALL").prop('checked', true).parent().addClass("ez-checked");
                    $("#chkChoiceAgreementForThirdPartyShinhan").prop('checked', true).parent().addClass("ez-checked");
                    $("#chkChoiceAgreementForThirdPartyTelecom").prop('checked', true).parent().addClass("ez-checked");
                    $("#chkChoiceAgreementForThirdParty").prop('checked', true).parent().addClass("ez-checked");
                    //if ($("#chkChoiceAgreementForThirdPartyTelecom").is(':checked')) { //통신 체크 
                    //        $("#chkChoiceAgreementForThirdParty").prop('checked', true).parent().addClass("ez-checked");
                    //        $("#chkChoiceAgreementForThirdPartyTelecomALL").prop('checked', true).parent().addClass("ez-checked");
                    //    }
                    //else {
                    //        $("#chkChoiceAgreementForThirdParty").prop('checked', false).parent().removeClass("ez-checked");
                    //        $("#chkChoiceAgreementForThirdPartyTelecomALL").prop('checked', false).parent().removeClass("ez-checked");
                    //    }

                }
                //else if ($(this).attr("id") == "chkChoiceAgreementForThirdPartyTelecom") //통신
                //{
                //    if ($("#chkChoiceAgreementForThirdPartyShinhan").is(':checked')) { //금융 체크
                //        $("#chkChoiceAgreementForThirdPartyTelecomALL").prop('checked', true).parent().addClass("ez-checked");
                //    }
                //    else {
                //        $("#chkChoiceAgreementForThirdPartyTelecomALL").prop('checked', false).parent().removeClass("ez-checked");
                //    }
                //}
                //else if ($(this).attr("id") == "chkChoiceAgreementForThirdPartyTelecomALL") //제3자 마케팅 활용동의
                //{
                //    if (!$("#chkChoiceAgreementForThirdPartyShinhan").is(':checked')) { //금융 체크
                //        $("#chkChoiceAgreementForThirdPartyShinhan").prop('checked', true).parent().addClass("ez-checked");
                //    }
                ...
                {
                    $("#chkChoiceAgreementForThirdPartyTelecomALL").prop('checked', false).parent().removeClass("ez-checked");
                    $("#chkChoiceAgreementForThirdPartyShinhan").prop('checked', false).parent().removeClass("ez-checked");
                    $("#chkChoiceAgreementForThirdPartyTelecom").prop('checked', false).parent().removeClass("ez-checked");
                    $("#chkChoiceAgreementForThirdParty").prop('checked', false).parent().removeClass("ez-checked");
                ...
                //if ($(this).attr("id") == "chkChoiceAgreementForThirdPartyShinhan") //금융 언체크 
                //{
                ...
                //}
                //else if ($(this).attr("id") == "chkChoiceAgreementForThirdPartyTelecom") //통신 언체크
                //{
                //    if ($("#chkChoiceAgreementForThirdPartyShinhan").is(':checked')) { //금융 체크
                //        $("#chkChoiceAgreementForThirdPartyTelecomALL").prop('checked', false).parent().removeClass("ez-checked");
                //    }
            ...
            //$("#chkChoiceAgreementForCasamiaMembership").prop('checked', false)
           ...
           // alert($("#chkChoiceAgreementForCasamiaMembership4").is(':checked'))
            if ($(this).is(':checked')) {
                ...
                //var Lgchkyn = $(this).attr("id").toLowerCase().indexOf("forlg");
                //alert(Lgchkyn)

                //if (Lgchkyn > -1) {


                //    if ($(this).attr("id") == "chkChoiceAgreementForLGMembershipALL") {
        ...
        //alert($check_frist_allbutton.html());
    ...
    function ALL_Check() {
        if ($("#chkAgeAgreement").is(':checked') &&
            $("#chkEssentialAgreement").is(':checked') &&
            $("#chkEssentialAgreementPurpose").is(':checked') &&
            $("#chkChoiceAgreementForLGMembershipALL").is(':checked') &&
            $("#chkChoiceAgreementForCasamiaMembershipALL").is(':checked') &&
            $("#chkChoiceAgreementForThirdPartyTelecomALL").is(':checked') &&
            $("#chkChoiceAgreementForThirdParty").is(':checked')) {
