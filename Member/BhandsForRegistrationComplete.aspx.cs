...
{
    public partial class BhandsForRegistrationComplete : System.Web.UI.Page
    {
        ...
        public String createBrandURL()
        {
            ...
            {
                sb.AppendLine(@"<div class='b_btn_a'><a href='http://m.bhandscard.com/' target='_parent' class='b_btn type2 '><span>홈으로 가기</span></a></div>");
            }
            else
            {
                sb.AppendLine(@"<div class='b_btn_a'><a href='http://www.bhandscard.com/' target='_parent' class='b_btn type2 '><span>홈으로 가기</span></a></div>");
            }
            return sb.ToString();
        }
