...
namespace BarunnIntergrationService.Member
{
    ...
    public partial class BarunsonMcardForCustomerInformation : System.Web.UI.Page
    {
                    ...
                    else
                    {
                        if (isSuccess)
                        {
                            ...
                            if (result.Success)
                            {
                                ...
                                Response.Redirect("/Member/BarunsonMcardForRegistrationComplete.aspx?USER_ID=" + txtID.Value);
